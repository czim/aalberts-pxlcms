...
use Aalberts\Filters\ParameterFilters\Product\FinishingParameter;
use Czim\Filter\Contracts\ParameterFilterInterface;

class FinishingCounter extends AbstractProductCounter
{
    ...
    {
        return \App\Models\Aalberts\Compano\Finishing::class;
    }
    ...
    {
        return \App\Models\Aalberts\Filter\Finishing::class;
    }
