...
use Aalberts\Filters\ParameterFilters\Product\ShapeParameter;
use Czim\Filter\Contracts\ParameterFilterInterface;

class ShapeCounter extends AbstractProductCounter
{
    ...
    {
        return \App\Models\Aalberts\Compano\Shape::class;
    }
    ...
    {
        return \App\Models\Aalberts\Filter\Shape::class;
    }
