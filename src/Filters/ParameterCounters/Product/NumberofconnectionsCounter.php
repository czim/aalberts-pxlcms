...
use Aalberts\Filters\ParameterFilters\Product\NumberofconnectionsParameter;
use Czim\Filter\Contracts\ParameterFilterInterface;

class NumberofconnectionsCounter extends AbstractProductCounter
{
    ...
    {
        return \App\Models\Aalberts\Compano\Numberofconnection::class;
    }
    ...
    {
        return \App\Models\Aalberts\Filter\Numberofconnection::class;
    }
    ...
    {
        return new NumberofconnectionParameter();
    }
