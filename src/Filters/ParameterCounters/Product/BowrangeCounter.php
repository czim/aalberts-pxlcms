...
use Aalberts\Filters\ParameterFilters\Product\BowrangeParameter;
use Czim\Filter\Contracts\ParameterFilterInterface;

class BowrangeCounter extends AbstractProductCounter
{
    ...
    {
        return \App\Models\Aalberts\Compano\Bowrange::class;
    }
    ...
    {
        return \App\Models\Aalberts\Filter\Bowrange::class;
    }
